          ...
          <div className={`${styles.card} card border-dark h-100 mt-4`}>
            ...
            <div className="card-body my-3">
              ...
              <p align="justify" className="card-text">
                ...
                Poor grammar and wrong choice of words creates a negative
                impression in the minds of others. While it's true that it's
                hard to change accents and one should not be penalized for it -
                but a heavy accent sometimes makes it hard to understand speech
                and gives an impression of improper word or grammar usage. How
                to improve the scores? Practice speaking with friends and take
                their feedback about your grammar usage style. Attempt various
                other virtual interactions and check your grammar & accent
