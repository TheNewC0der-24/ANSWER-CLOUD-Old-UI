    ...
    return (
        <>
            <div className="container mt-3" style={{ height: '350px' }}>
                <h1 className="mb-3">
                    <span className="badge bg-dark text-center" style={{ borderRadius: "0" }}><span className='me-1 fw-bold' style={{ fontFamily: 'Brush Script MT' }}>A</span>nswer domain ratings<span className="badge bg-danger">Experimental</span></span>
