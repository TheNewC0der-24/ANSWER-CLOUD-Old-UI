        ...
        <>
            <div className="container my-5">
                <div className='d-flex justify-content-between my-5'>
                    <h1>
                        <span className="badge" style={{ backgroundColor: "#414141", borderRadius: "0" }}><span className='me-1 fw-bold' style={{ fontFamily: 'Brush Script MT' }}>A</span>nswer domain ratings</span>
                    </h1>
                    <h3><span className="badge bg-danger" style={{ borderRadius: "0" }}>Experimental</span></h3>
                </div>
                <div style={{ fontFamily: "Mukta, sans-serif", fontSize: "30px" }}>
                    <p align="justify">
