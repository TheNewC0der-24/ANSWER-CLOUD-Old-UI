          ...
          <div className="row">
            <div className="col-md-6">
              <ul>
                ...
                <p align='justify'>
                  All of us have heard and likely commented, “I like that guy/gal!” The science of likeability says that the smile is
                  the biggest key ingredient of liking an individual. Researchers say the ability to smile and remain stress free are
                  key markers of a successful interaction. How much and how frequently you smile gives out subtle indications that you
                  are in control of the conversation. This should not be confused with laughter. Our algorithms generate proprietary
                  scores that divide this power-skill of Likeability & Trust in four cohorts as a relative barometer of the aspirant’s
                  performance.  So how can you improve your scores? Simple, practice delivering your responses with a smile as if you
                ...
                <p align='justify'>
                  Who doesn’t want to be charming? Did you know that certain body language markers like eye movement and gazes’
                  signals critical characters like empathy and charm? Human resource experts and researchers have discovered that
                  empathy is one of the power skills as a leader. Something that one must consistently try to improve upon. Our
                  algorithms generate proprietary scores that divide this power skill of Empathy & charm in four cohorts, as a
                  relative barometer of the candidate’s charm. This should not be confused with excessive expressions. So how can you
                  improve your scores? Simple, practice delivering the answers looking directly in the eyes/face when communicating
                ...
                <p align='justify'>
                  ...
                  friends and colleagues.Researchers have discovered that we often associate the label of “low-confidence” with
                  such people. Our algorithms generate proprietary scores that divide this power - skill of Confidence in four
                  cohorts, as a relative barometer, of the candidate’s confidence. This should not be confused with word play. <em>So
                    how can you improve your scores?</em> Simple, think and answer in a calculated manner without any unnecessary words.
            ...
            <div className="col-md-6">
              <ul>
                ...
                <p align="justify">
                  ...
                  generate proprietary scores that divide this power-skill of energy into four cohorts, as a relative barometer, of the
                  candidate’s energy level and adaptability. This should not be confused with merely a loud voice. <em>So how can you
                    improve your scores?</em> Simple, practice delivering the answers with good voice modulation and pitch range along
                ...
                <p align="justify">
                  ...
                  of the candidate’s communication abilities. <em>So how can you improve your scores?</em> Simple, practice delivering the
                  answers with which are well thought out. Request for a minute to formulate your answers before you start speaking
                ...
                <p align="justify">
                  ...
                  in the interaction and has command over the situation. Another critical power skill in leadership development. <em>How
                    to improve the scores?</em> Of Course knowing the answers and content is the key first step. Further, the aspirant
                  must take time to understand and align to the operating context and industry specific terminologies to articulate
                  answers. This will enhance the content ratings. One can also keep in mind to use certain keywords to improve their
