              ...
              <div className="card-body">
                ...
                <Form className="mt-5">
                  <div className="row">
                    <div className="col-md-6">
                      <div className="mb-3">
                        <Field
                          type="text"
                          className={`form-control ${errors.firstname && touched.firstname ? 'border-danger' : ""}`}
                          id="firstName"
                          name="firstname"
                          placeholder="First Name"
                          validate={validateFirstName}
                        />
                        {errors.firstname && touched.firstname && <div className="form-text text-danger">{errors.firstname}</div>}
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="mb-3">
                        <Field
                          type="text"
                          className={`form-control ${errors.lastname && touched.lastname ? 'border-danger' : ""}`}
                          id="lastName"
                          name="lastname"
                          placeholder="Last Name"
                          validate={validateLastName}
                        />
                      {errors.lastname && touched.lastname && <div className="form-text text-danger">{errors.lastname}</div>}
                      </div>
                    </div>
                  </div>
                  <div className="mb-3">
                    ...
                    />
                    {errors.username && touched.username && <div className="form-text text-danger">{errors.username}</div>}
                  </div>
                  <div className="mb-3">
                    <Field
                      type="email"
                  ...
                  <div className="mb-3">
                    ...
                    />
                    {errors.confirmpassword && touched.confirmpassword && <div className="form-text text-danger">{errors.confirmpassword}</div>}
                  </div>
                  <div className="mb-3">
                    <Field
                      type="number"
                      className={`form-control ${errors.invitecode && touched.invitecode ? 'border-danger' : ""}`}
                      id="inviteCode"
                      name="invitecode"
                      placeholder="Invitation Code"
                      validate={validateInviteCode}
                    />
                    {errors.invitecode && touched.invitecode && <div className="form-text text-danger">{errors.invitecode}</div>}
                  </div>
