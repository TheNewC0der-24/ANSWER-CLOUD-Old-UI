    ...
    axios
      .post(
        "response.json",
        {
          ...
          collect_candidate_feedback_message:
            create.collect_candidate_feedback_message,
          ...
          report_send_to_email: create.report_send_to_email,
        },
        {
          method: "POST",
          headers: {
    ...
    <>
      ...
      <div className="container my-4 mx-auto">
        <div className="d-flex justify-content-center mx-auto">
          <div className="mb-3">
            <label className="form-label fw-bold fs-1">
              Do you need external bot ?
            </label>
                ...
                <form>
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <button onClick={handleUpload} className="btn btn-dark button mb-3">
                        Upload
                      </button>
                    </div>
                  </div>
                    ...
                    <form>
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="emailTwo"
                          onChange={handleOnChange}
                          name="report_send_to_email"
                          value={create.report_send_to_email}
                        />
                      </div>
                      <div className="mb-3">
                        <label className="form-label fw-bold" htmlFor="report">
                          Report sent to User
                        </label>
                        <select
                          className="form-select"
              ...
              <div className="col-md-7">
                <div className={`${styles.right} card border-0 shadow`}>
                  ...
                  <div className="card-body">
                    <form>
                      <div className="mb-3">
                        <label htmlFor="welcome" className="form-label fw-bold">
                      ...
                      <div className="mb-3">
                        <label htmlFor="dark" className="form-label fw-bold">
                          Bot Message
                        </label>
                        <textarea
                          className="form-control interaction"
