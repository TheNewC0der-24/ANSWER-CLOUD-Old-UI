    ...
    axios
      .post(
        "response.json",
        {
          ...
          hint: create.hint,
          hints: create.hints,
          media_context: create.media_context,
          media_contexts: create.media_contexts,
          answer_format: create.answer_format,
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <div>
                ...
                <button onClick={handleSubmit} type="button" className="btn btn-dark mx-1">
                  Save changes
                </button>
              </div>
            </div>
